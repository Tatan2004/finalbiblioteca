...
def add_transaction():
    ...
    try:
        ...
        if data['tipo_transaccion'] == 1:  # VENTA
            ...
            nueva_cantidad = cantidad_actual - data['cantidad']  # Correcto: Restar la cantidad vendida
            monto = data['cantidad'] * precio_venta  # Correcto: Calcular el ingreso total
            tipo_movimiento = 'INGRESO'
        else:  # ABASTECIMIENTO
            nueva_cantidad = cantidad_actual + data['cantidad']  # Correcto: Sumar la cantidad abastecida
            monto = data['cantidad'] * precio_compra  # Correcto: Calcular el costo total
